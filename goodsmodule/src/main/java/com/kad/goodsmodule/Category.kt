...
class Category {
    ...
    class ResultsBean {
        ...
        var resource: List<ResourceBean>? = null
        var video: List<VideoBean>? = null
        var welfare: List<WelfareBean>? = null
